...
// vocabulary and the Myers algorithm. It tokenizes strings into lines, words,
// or characters, diffs the tokens, and exposes the result as tagged changes,
// a similarity ratio, grouped ops, a remapper onto the original strings, and a
// difflib-style close-match finder.
//
